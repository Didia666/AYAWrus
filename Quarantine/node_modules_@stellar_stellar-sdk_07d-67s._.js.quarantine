...
function readChallengeTx(challengeTx, serverAccountID, networkPassphrase, homeDomains, webAuthDomain) {
    ...
    var _transaction$operatio = _toArray(transaction.operations), operation = _transaction$operatio[0], subsequentOperations = _arrayLikeToArray(_transaction$operatio).slice(1);
    if (!operation.source) {
...
//# sourceMappingURL=node_modules_%40stellar_stellar-sdk_07d-67s._.js.map